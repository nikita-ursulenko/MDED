...
if (function_exists('acf_add_local_field_group')) {
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            ...
            array(
                'key' => 'field_faq_question_text_en',
                'label' => 'Question (EN)',
                'name' => 'question_text_en',
                'type' => 'text',
                'instructions' => 'Enter the question for the English version.',
                'required' => 0,
            ),
            array(
                'key' => 'field_faq_answer_text_en',
                'label' => 'Answer (EN)',
                'name' => 'answer_text_en',
                'type' => 'textarea',
                'tabs' => 'visual',
        ...
        'hide_on_screen' => '',
        'active' => true,
        'description' => 'Câmpuri pentru întrebările și răspunsurile FAQ.',
    ));
}
