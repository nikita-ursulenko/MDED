...
// functions.php (в корне вашей активной темы)
// Добавьте эту строку в ваш файл functions.php
// require_once get_theme_file_path('/admin/inc/seopress-acf.php');
...
add_action('after_setup_theme', function() {
    register_nav_menu('main_menu', __('Main Menu'));
      // Добавляем поддержку "title-tag" для правильного отображения заголовка
...
require_once get_template_directory() . '/admin/acf-eligibile.php';


// Регистрируем переменную
add_filter('seopress_dynamic_variables', function ($vars) {
    $vars['card_1_button_text'] = [
...
// Обрабатываем подстановку значения
add_filter('seopress_dynamic_variables_callback', function ($value, $var) {
    if ($var === 'card_1_button_text') {
        $acf_value = get_field('card_1_button_text');
        if ($acf_value) {
            return $acf_value;
        }
    }
